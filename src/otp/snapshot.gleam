...
/// Rarely changing dispatcher configuration kept across process restarts.
/// Pending and in-flight events intentionally remain in bounded process memory.
pub type Snapshot {
  Snapshot(default_user: event.User, transport: Option(String))
}
